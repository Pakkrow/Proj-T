...
const SelectedPokeCard = ({ name, is_shiny }) => {
        ...
        <div className="statCol">
          ...
          {stats.map((stat, index) => (
            <section
              ...
              style={
                index === 0 ? { justifyContent: "center" } : { height: "25px" }
              }
            >
              <button
                ...
                className={
                  index != 0
                    ? stat.stat.name === statUp
                      ? "selectedNatureUpButt"
                      : "natureButt naturePlusButt"
                    : "noDisplay"
                }
              >
                +
              ...
              <button
                ...
                className={
                  index != 0
                    ? stat.stat.name === statDown
                      ? "selectedNatureDownButt"
                      : "natureButt natureDownButt"
                    : "noDisplay"
                }
              >
                -
